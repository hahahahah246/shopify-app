...
<div id="palleon-adjust" class="palleon-icon-panel-content">
    ...
    <?php do_action('palleon_before_filters'); ?>
    <hr class="hide-on-canvas-mode" />
    <?php } ?>
    <?php if ($image_filters == 'enable') { ?>
    <ul class="palleon-accordion hide-on-canvas-mode">
    <li id="palleon-quick-filters-li">
            <a href="#"><span class="material-icons accordion-icon">auto_fix_high</span><?php echo esc_html__('Quick Filters', 'palleon'); ?><span class="data-count">14</span><span class="material-icons arrow">keyboard_arrow_down</span></a>
            <div>
        ...
        <li id="palleon-filters-li">
            <a href="#"><span class="material-icons accordion-icon">auto_fix_high</span><?php echo esc_html__('Filter Library', 'palleon'); ?><span class="data-count">76</span><span class="material-icons arrow">keyboard_arrow_down</span></a>
            <div>
                <div id="palleon-filter-preview" class="d-none">
                    <img src="" />
                </div>
                <div id="palleon-filter-library" class="palleon-grid three-column paginated" data-perpage="12">
                    <div class="grid-item none" data-filter="" title="<?php echo esc_attr__('Clear Filters', 'palleon'); ?>">
                        <span class="material-icons">block</span>
                        <img src="<?php echo esc_url(PALLEON_PLUGIN_URL . 'assets/filters/default.png'); ?>" />
                    </div>
                    <?php
                    echo Palleon::get_image_filters();
                    ?>
                    <div class="grid-item none" data-filter="" title="<?php echo esc_attr__('Clear Filters', 'palleon'); ?>">
                        <span class="material-icons">block</span>
                        <img src="<?php echo esc_url(PALLEON_PLUGIN_URL . 'assets/filters/default.png'); ?>" />

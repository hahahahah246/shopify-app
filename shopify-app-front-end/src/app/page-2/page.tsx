...
export default function Component() {
  return (
    <div className="grid min-h-screen w-full lg:grid-cols-[200px_280px_1fr] md:grid-cols-[200px_1fr] sm:grid-cols-1">
        ...
        <div className="flex h-full max-h-screen flex-col gap-4">
          <div className="flex h-[60px] items-center border-b px-6">
            <div className="flex items-center justify-between w-full">
              ...
              <span className="flex font-semibold text-center">Random Shirt Name</span>
      ...
      <div className="hidden border-r bg-muted/40 lg:block md:block">
        <div className="flex h-full max-h-screen flex-col gap-2">
          ...
          <div className="flex-1 overflow-auto py-2">
            <nav className="grid items-start px-2 text-sm font-medium">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 mr-10">
                ...
                <div className="aspect-square rounded-md flex justify-center items-center bg-gray-400 animate-pulse" />
                <div className="aspect-square rounded-md flex justify-center items-center bg-gray-400 animate-pulse" />
                <h3 className="col-span-4 text-lg font-semibold mt-4">Sizes</h3>                                                                                
  ...
  <div className="flex items-center gap-2">
    ...
    <Label htmlFor="size-4xl">4XL</Label>
      ...
      <div className="flex flex-col">
        ...
        <footer className="bg-gray-100 p-4 flex flex-wrap justify-between items-center z-10">
      <div>
        <p>Shirt</p>
        <p className="font-bold">Price:22.83</p>
      </div>
      <Button className="mt-2 sm:mt-0">Unsave Template</Button>
    </footer>

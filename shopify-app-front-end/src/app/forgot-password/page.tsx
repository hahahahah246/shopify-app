        ...
        <div className="relative flex items-center justify-center p-6 lg:p-12">
          <div className="relative z-10 mx-auto w-full max-w-md space-y-4">
            <div className="space-y-2 text-center">
              <h2 className="text-2xl font-bold text-primary-foreground">Reset Your Passqord</h2>
              <p className="text-primary-foreground">Enter your email to recive password reset email.</p>
            </div>
